 ...
 */
export const LevelMeter = ({ peak, className }: LevelMeterProps) => {
  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      ...
      <span className="w-28 shrink-0 text-right font-mono text-xs text-text-dim tabular-nums">
        {pct}% {state}
      </span>
    </div>
  );
